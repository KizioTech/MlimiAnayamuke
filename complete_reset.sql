-- Complete Database Reset - Handles Dependencies
...
-- Step 4: Drop tables (this will also drop any remaining triggers)
DROP TABLE IF EXISTS consultations CASCADE;
DROP TABLE IF EXISTS farms CASCADE;
DROP TABLE IF EXISTS profiles CASCADE;

-- Step 5: Create clean tables
...
-- Step 6: Keep RLS disabled for testing
ALTER TABLE profiles DISABLE ROW LEVEL SECURITY;
ALTER TABLE farms DISABLE ROW LEVEL SECURITY;
ALTER TABLE consultations DISABLE ROW LEVEL SECURITY;

-- Step 7: Create simple trigger
...
-- Step 8: Test complete - user registration should work now
-- After confirming registration works, run the next part manually:
